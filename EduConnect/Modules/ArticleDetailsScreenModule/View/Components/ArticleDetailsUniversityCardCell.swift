//
//  ArticleDetailsUniversityCard.swift
//  EduConnect
//
//  Created by Buzurg Rakhimzoda on 8.03.2026.
//
...
struct ArticleDetailsUniversityCardCellViewModel {
    let newsType: ECNewsType
    let university: ECNews.University
    var didTapUniversity: ((Int) -> Void)? = nil
}

final class ArticleDetailsUniversityCardCell: UICollectionViewCell {
    // MARK: - CONSTANTS
    ...
    // MARK: - PROPERTIES
    private var viewModel: ArticleDetailsUniversityCardCellViewModel?
